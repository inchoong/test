    ...
    function map() {
        ...
        mapFeatures.forEach(function(v) {
            ...
            toolTipData.push({
                ...
                value: [{
                    name: "平衡氢膳",
                    value: Math.round(Math.random() * 100 + 10) + '套'
                },
                    {
                        name: "波动仪",
                        value: Math.round(Math.random() * 100 + 10)+ '套'
            ...
            xAxis : [
                {
                    ...
                    data: ['1号','2号','3号','4号','5号','6号','7号','8号','9号','10号','11号','12号','13号','14号','15号','16号','17号'
